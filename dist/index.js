...
var users = mysqlTable("users", {
  ...
  // admin, media_buyer, creator, viewer
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().onUpdateNow().notNull()
});
var creativePosts = mysqlTable("creative_posts", {
  id: int("id").autoincrement().primaryKey(),
  ...
  // Pending, Approved, Published, Returned, Back for Update, Closed, Archived
...
var briefs = mysqlTable("briefs", {
  ...
  // Draft, Published, Seen, In Progress, Submitted, Done
...
var dailyReports = mysqlTable("daily_reports", {
  id: int("id").autoincrement().primaryKey(),
...
var activityLogs = mysqlTable("activity_logs", {
  ...
  // creative_uploaded, creative_approved, etc
  targetId: int("target_id"),
  targetType: varchar("target_type", { length: 50 }),
  details: text("details"),
  createdAt: timestamp("created_at").defaultNow().notNull()
});
var standups = mysqlTable("standups", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("user_id").notNull(),
...
var appRouter = router({
  ...
  workflow: router({
    ...
    getRequest: publicProcedure.input(z2.object({ id: z2.number() })).query(() => null),
    createRequest: publicProcedure.input(z2.object({ title: z2.string(), description: z2.string() })).mutation(() => ({ success: true }))
  }),
  briefs: router({
    getAll: publicProcedure.query(() => []),
    create: publicProcedure.input(z2.object({ title: z2.string() })).mutation(() => ({ success: true }))
  }),
  activityLog: router({
    getAll: publicProcedure.query(() => [])
  })
